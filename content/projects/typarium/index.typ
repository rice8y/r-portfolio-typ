...
For the full guide and API reference, see #link("https://github.com/rice8y/typarium/blob/main/package/docs/documentation.pdf")[documentation.pdf].
...
#img("/images/projects/typarium/sample01.png", alt: "Basic local specimen")
...
#img("/images/projects/typarium/sample02.png", alt: "Anatomy renderer")
...
#img("/images/projects/typarium/sample03.png", alt: "Custom renderer")
...
#img("/images/projects/typarium/sample04.png", alt: "Mixed input array")
...
#img("/images/projects/typarium/sample05.png", alt: "Top-level theme override")
...
#img("/images/projects/typarium/sample06.png", alt: "Per-font theme override")
...
+ `font-showcase` normalizes the input shape and resolves the showcase-level theme.
+ Raw font bytes, including bytes read internally from Typst 0.15.0+ path sources, are passed to `font_parser.wasm`.
+ The Rust parser extracts names, permissions, collection summaries, metrics, variation axes, table diagnostics, codepoint samples, glyph-name indices, and per-glyph metric/image records.
+ Metadata keys are normalized into Typst-friendly hyphenated names.
+ A prepared `font-text` helper is created from the resolved font family and shaping options.
+ Variable-axis requests are normalized into `variation-request` metadata for renderers.
+ The bundled or custom renderer receives the final render payload as `it`.
