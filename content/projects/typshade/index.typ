...
Inspired by #link("https://ctan.org/pkg/texshade")[TeXshade], Typshade rethinks alignment visualization with a focus on clarity, composability, and a Typst-native user experience.
...
#img("/images/projects/typshade/readme-preview-1.png", alt: "Protein alignment preview")

Protein alignment with hydropathy-based functional coloring:

#img("/images/projects/typshade/readme-preview-2.png", alt: "Hydropathy preview")

Nucleotide alignment with DNA coloring, a sequence logo, a conservation track,
and a ruler:

#img("/images/projects/typshade/readme-preview-3.png", alt: "DNA alignment preview")
