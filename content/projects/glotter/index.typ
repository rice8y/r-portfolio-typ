...
#img("/images/projects/glotter/example01.png", alt: "Example of lang function")
...
#img("/images/projects/glotter/example02.png", alt: "Example of detect-info function")
...
#img("/images/projects/glotter/example03.png", alt: "Example of auto-text function")
...
#img("/images/projects/glotter/example04.png", alt: "Example of auto-par function")
...
#img("/images/projects/glotter/example05.png", alt: "Example of multilingual template")
...
#img("/images/projects/glotter/example06.png", alt: "Example of language-dependent rendering")
...
Official source: #link("https://fasttext.cc/docs/en/language-identification.html")[https://fasttext.cc/docs/en/language-identification.html]
...
However, this package includes `package/glotter.wasm`, which embeds model data from `lid.176.ftz`. For that reason, the package contains material under both:
