...
When a subtree requires raster-domain processing, it uses hybrid rendering instead of silently dropping the feature.
...
For a fuller user guide, see #link("https://github.com/rice8y/svg2tex-rs/blob/main/docs/documentation.pdf")[`docs/documentation.pdf`].
